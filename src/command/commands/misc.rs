...
impl Command for DisplayFile {
    fn execute(&mut self, editor: &mut Editor) {
      ...
      editor.status_line = format!("\"{}\" line {} of {} --{}%-- col {} char {}",
        file_name,
        ...
        editor.buffer.lines[editor.cursor_position_in_buffer.row].chars().nth(editor.cursor_position_in_buffer.col).unwrap_or(' ')
      );
    }
}
